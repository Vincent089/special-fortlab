...
from config_parser.classes.device import Device
from config_parser.services.device_net_connector import DeviceNetworkConnector
from config_parser.services.device_repository import DeviceRepository


class DeviceManager:

    def __init__(self):
        logging.basicConfig(filename=r'../../logs/device_manager.log',
                            level=logging.INFO)
